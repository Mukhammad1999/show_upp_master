...
class __$$SuccessCopyWithImpl<$Res> extends _$LoginStateCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? loginResponseEntity = freezed,
  }) {
    return _then(_$Success(
      loginResponseEntity: loginResponseEntity == freezed
...
class _$Success implements Success {
  const _$Success({required this.loginResponseEntity});
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.loginResponseEntity, loginResponseEntity));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(loginResponseEntity));
...
abstract class Success implements LoginState {
  const factory Success(
      {required final LoginResponseEntity loginResponseEntity}) = _$Success;
